                ...
                <div className="options">
                    <h4>
                        <Avatar
                            color="green"
                            name={
                                validOwner ? state.question.owner[0].name : ""
                            }
                            size="40"
                            round
                        />
                    ...
                    <div className="flex">
                        <p>
                            <span className="green-text">65%</span> acertaram
                            essa questão
                        </p>
                        <div>
                            {isBookmarked ? (
                                <button
                                    className="icon yellow-text text-darken-2 tooltipped"
                            ...
                            {isOwner && (
                                <React.Fragment>
                                    <button
                                        className="icon blue-text tooltipped"
                                    ...
                                    <button
                                        className="icon red-text tooltipped"
